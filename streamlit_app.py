...
def generar_informe_word():
    ...
    doc.add_paragraph(
        "- Cantidad de hogares analizados: 19.035 hogares únicos.
"
...
"
    ...
    doc.add_paragraph(
        "La mayoría de las personas viven en condiciones adecuadas. Se observa una estructura social "
